...
module Gen.Caffe.V1LayerParameter.DimCheckMode (DimCheckMode(..)) where
import Prelude ((+), (/), (.))
...
instance Prelude'.Enum DimCheckMode where
  ...
  toEnum
   = P'.fromMaybe (Prelude'.error "hprotoc generated code: toEnum failure for type Gen.Caffe.V1LayerParameter.DimCheckMode") .
      toMaybe'Enum
  succ STRICT = PERMISSIVE
  succ _ = Prelude'.error "hprotoc generated code: succ failure for type Gen.Caffe.V1LayerParameter.DimCheckMode"
  pred PERMISSIVE = STRICT
  pred _ = Prelude'.error "hprotoc generated code: pred failure for type Gen.Caffe.V1LayerParameter.DimCheckMode"
...
instance P'.ReflectEnum DimCheckMode where
  ...
  reflectEnumInfo _
   = P'.EnumInfo (P'.makePNF (P'.pack ".caffe.V1LayerParameter.DimCheckMode") ["Gen"] ["Caffe", "V1LayerParameter"] "DimCheckMode")
      ["Gen", "Caffe", "V1LayerParameter", "DimCheckMode.hs"]
      [(0, "STRICT"), (1, "PERMISSIVE")]

instance P'.TextType DimCheckMode where
  tellT = P'.tellShow
  getT = P'.getRead